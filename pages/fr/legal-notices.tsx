...
const LegalNotices: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '2rem auto', padding: '2rem' }}>
      ...
      <p>
        {intl.formatMessage({
          id: 'legalNoticesText1',
          defaultMessage:
            'Ce site est exploité par Juliane Hendershot. Pour toute question juridique, veuillez utiliser le formulaire de contact.',
        })}
      </p>
      <Link href='/fr/privacy-policy'>
        {intl.formatMessage({
